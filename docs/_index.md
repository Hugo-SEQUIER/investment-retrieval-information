...
## Purpose
- Short routing index for project documentation.

## Sections
| Section | Path | Owner | Status |
|---|---|---|---|
| Project overview | `README.md` | core team | active |
| Documentation index | `docs/_index.md` | core team | active |
| Architecture index | `docs/architecture/_index.md` | core team | active |
