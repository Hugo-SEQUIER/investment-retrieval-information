...
| DEC-004 | Canonical company identity is `exchange:ticker` | accepted | 2026-04-12 | core team | `docs/decision-index.md` |
| DEC-005 | Run discovery on both X and Reddit for global coverage | accepted | 2026-04-12 | core team | `docs/decision-index.md` |
| DEC-006 | Markdown is the canonical report output in v1 | accepted | 2026-04-12 | core team | `docs/decision-index.md` |
...
| DEC-010 | v1.1 run triggering uses single active run policy and subprocess execution model | accepted | 2026-04-12 | core team | `src/ai_equity_discovery/api/runner.py` |
| DEC-011 | v1.1 live monitor uses polling-first updates before SSE/WebSocket | accepted | 2026-04-12 | core team | `frontend/app/page.tsx` |
